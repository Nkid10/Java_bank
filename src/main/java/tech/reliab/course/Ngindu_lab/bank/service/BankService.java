...
public interface BankService {
     ...
     *
     * @param bank банк, из которого удаляется пользователь
     * @param user пользователь, которого нужно удалить из банка
     * @return true, если получилось удалить пользователя, false -- в противном случае
     */
