...
import tech.reliab.course.Ngindu_lab.bank.entity.CreditAccount;
import tech.reliab.course.Ngindu_lab.bank.entity.Employee;
import tech.reliab.course.Ngindu_lab.bank.entity.PaymentAccount;
import tech.reliab.course.Ngindu_lab.bank.entity.User;
import tech.reliab.course.Ngindu_lab.bank.enums.BankAtmStatus;
import tech.reliab.course.Ngindu_lab.bank.enums.JobName;
import tech.reliab.course.Ngindu_lab.bank.exceptions.*;
import tech.reliab.course.Ngindu_lab.bank.service.CreditAccountService;
import tech.reliab.course.Ngindu_lab.bank.service.PaymentAccountService;
import tech.reliab.course.Ngindu_lab.bank.service.impl.*;
        ...
        while (!quitProgram) {
            ...
            switch (action) {
                case 1:
                    ...
                    if (bankId < 5)
                        ((BankServiceImpl) bankService).printInfo(banks.get(bankId));
                    else
                        System.out.println("\nНеверный id банка!  ");
